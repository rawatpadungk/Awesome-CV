...
\makecvfooter
  % {\today}
  {}
  {Rawat Padungkiettiwong~~~·~~~Curriculum Vitae}
  % {Rawat Padungkiettiwong~~~·~~~Resume}
  {\thepage}
...
\input{cv/skills.tex}
\input{cv/prerequisites_utaustin.tex}
